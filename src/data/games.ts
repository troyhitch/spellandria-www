...
export const games: Record<GameKey, GameConfig> = {
  duelcasters: {
    ...
    fullTitle: 'DuelCasters of SpellRealms',
  ...
  realms: {
    ...
    shortTitle: 'Realms',
    fullTitle: 'Realms of SpellRealms',
    kicker: 'Coming next',
    tagline: 'Journey beyond the towers into the fractured lands shaped by living language.',
    description: 'A broader adventure through the outer territories of SpellRealms, where ancient orders, ruined civilizations, and unstable magic systems collide across a world far larger than the dueling halls.',
  ...
  spires: {
    ...
    shortTitle: 'Spires',
    fullTitle: 'Spires of SpellRealms',
